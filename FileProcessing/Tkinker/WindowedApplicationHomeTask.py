...
def callback_error(self, *args):
    tk.messagebox.showerror('Error', 'Error occurred. Error log saved to ' + abspath(Program.current_config['Error path']))
...
class MainWindow:
    def __init__(self, master=None):
        ...
        self.entry_add.configure(font='{Arial} 16 {bold}', foreground='#690f96', text='Add entry', command=lambda: AddWindow().run())
        ...
        self.setup_json.configure(font='{Arial} 16 {bold}', foreground='#690f96', text='Edit config', command=lambda: ConfigWindow().run())
        ...
        self.export_csv.configure(font='{Arial} 16 {bold}', foreground='#690f96', text='Export csv', command=lambda: [Program.export_data_to_csv(), messagebox.showinfo('', 'Done')])
        ...
        self.open_err_log.configure(font='{Arial} 16 {bold}', foreground='#690f96', text='Open error log', command=lambda: open_file(Program.current_config['Error path']))
        ...
        self.export_data.configure(font='{Arabic Transparent} 16 {bold}', foreground='#690f96', text='Export data', command=lambda: [Program.export_persons(), messagebox.showinfo('', 'Done')])
        ...
        self.open_json.configure(font='{Arial} 16 {bold}', foreground='#690f96', text='Open json file', command=lambda: open_file(Program.config_path))
        ...
        self.open_csv.configure(font='{Arial} 16 {bold}', foreground='#690f96', text='Open csv file', command=lambda: open_file(Program.current_config['Export path']))
        ...
        self.exit.configure(font='{Arial} 16 {bold}', foreground='#690f96', text='Exit', command=self.Main_window.destroy)
...
class AddWindow:
    def __init__(self, master=None):
        ...
        self.add.configure(command=lambda: {Program.create_person(self.name.get(), self.lastname.get(), self.job.get(), self.phone_number.get()), self.Add_window.destroy(), messagebox.showinfo('', 'Successfully added')})
        self.add.place(anchor='nw', height='80', relx='0.26', rely='0.7', width='175', x='0', y='0')
        self.cancel = tk.Button(self.Add_window)
        self.cancel.configure(font='{Arial Baltic} 16 {bold}', foreground='#690f96', text='Cancel', command=self.Add_window.destroy)
...
class ConfigWindow:
    def __init__(self, master=None):
        ...
        self.save_config.configure(command=lambda: {Program.save_changes_to_config(self.__tkvar_lang.get(), self.__tkvar_enc.get(), self.path_data.cget("text"),
        ...
        self.cancel.configure(font='{Arial Baltic} 16 {bold}', foreground='#690f96', text='Cancel', command=self.Config_window.destroy)
        ...
        self.path_data.configure(font='{Arial} 9 {bold}', foreground='#690f96', text=Program.current_config['Data path'])
        ...
        self.data_path.configure(font='{Arial} 12 {bold}', foreground='#690f96', text='Browse', command=lambda: choose_file(self.path_data))
        ...
        self.path_export.configure(font='{Arial} 9 {bold}', foreground='#690f96', text=Program.current_config['Export path'])
        ...
        self.browse_csv.configure(font='{Arial} 12 {bold}', foreground='#690f96', text='Browse', command=lambda: choose_file(self.path_export))
        ...
        self.path_error.configure(font='{Arial} 9 {bold}', foreground='#690f96', text=Program.current_config['Error path'])
        ...
        self.browse_error.configure(font='{Arial} 12 {bold}', foreground='#690f96', text='Browse', command=lambda: choose_file(self.path_error))
